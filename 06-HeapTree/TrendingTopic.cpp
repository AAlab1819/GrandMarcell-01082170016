...
int main()
{
    ...
    map<int, vector<topic> >Map; //map of zScore difference and vector of Topics
    topic Topic;
    cin>>test;
    while (test--)
    {
        ...
        Map[newZScore - oldZScore].push_back(Topic); //zScore difference will be the key, and the element will be Topic data type pushed to Vector
    }
